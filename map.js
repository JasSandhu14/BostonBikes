...
mapboxgl.accessToken = 'pk.eyJ1IjoiamFzLXNhbmRodSIsImEiOiJjbWFxNzN2bmMwNjQyMmlwcWNvaTB3ZzNoIn0.ekMQ7zgqsiU23v37zIrj_A';

// Initialize the map
const map = new mapboxgl.Map({
  container: 'map', // ID of the div where the map will render
  style: 'mapbox://styles/jas-sandhu/cmass2cld01gt01si4i8ohuwz', // Map style
...
map.on('load', async () => {
    ...
    try {
        ...
        console.error('Error loading JSON:', error); // Handle errorsI
    }
});
